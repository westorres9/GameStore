...
public ResponseEntity<PlatformDTO> findById(@PathVariable Long id) {
    ...
    @PostMapping
    public ResponseEntity<PlatformDTO> insert(@Valid @RequestBody PlatformDTO dto) {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<PlatformDTO> update(@PathVariable Long id, @Valid @RequestBody PlatformDTO dto) {
